...
struct smt_params_helper {
  ...
  static void collect_param_descrs(param_descrs & d) {
    ...
    d.insert("use_ls", CPK_BOOL, "use ls or not", "false","smt");
    d.insert("ls_time", CPK_UINT, "the time allocated for Local Search", "1200","smt");
  ...
  */
  ...
  bool use_ls() const { return p.get_bool("use_ls", g, false); }
  unsigned ls_time() const { return p.get_uint("ls_time", g, 1200u); }
